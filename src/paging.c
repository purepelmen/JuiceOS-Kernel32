...
void initialise_paging() {
    ...
    uint32_t mem_end_page = 0xc0000000;
    ...
    // If paging is enabled successfully
    print_log("Paging is set up and successfully enabled.\n");
}
